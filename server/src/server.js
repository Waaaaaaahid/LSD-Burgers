...
app.get('/api/health', (_req, res) => res.json({ success: true, service: 'lsd-burgers-api', status: 'ok', timestamp: new Date().toISOString() }));
...
async function start() {
  ...
  app.listen(PORT, '0.0.0.0', () => console.log(`LSD API listening on ${PORT}`));
}
